...
import com.cool.code.mapper.QuestionCodeMapper;
...
import com.cool.model.dto.questionSubmit.JudgeInfo;
...
public class QuestionCodeServiceImpl extends ServiceImpl<QuestionCodeMapper, QuestionCode>
    ...
    //根据用户id获取用户已完成的题目ID列表
    @Override
    public List<Long> getCompletedQuestionIds(Long userId) {
        return questionCodeMapper.selectCompletedQuestionIds(userId);
    }

    //获取用户最近时间段内完成的题目
    @Override
    public List<QuestionCode> selectRecentCompletedQuestions(Long userId, String date) {
        return questionCodeMapper.selectRecentCompletedQuestions(userId,date);
    }

    //获取最近时间段内完成的题目数量
    @Override
    public Integer getRecentCompletedQuestionsCount(Long userId, String date) {
        return questionCodeMapper.countUserCompletedQuestions(userId, date);
    }
}
