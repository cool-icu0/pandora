...
export async function getQuestionById2AnswerUsingGet(
  ...
  return request<API.BaseResponseQuestionCode_>('/api/questionCode/get2Answer', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listQuestionCodeByPageUsingPost(
  ...
  return request<API.BaseResponsePageQuestionCode_>('/api/questionCode/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listQuestionCodeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageQuestionCodeVO_>('/api/questionCode/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyQuestionCodeVoByPageUsingPost(
  ...
  return request<API.BaseResponsePageQuestionCodeVO_>('/api/questionCode/my/list/page/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function doQuestionCodeSubmitUsingPost(
  ...
  return request<API.BaseResponseLong_>('/api/questionCode/question_submit/do', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getQuestionCodeSubmitByIdUsingGet(
  ...
  return request<API.BaseResponseQuestionSubmitVO_>('/api/questionCode/question_submit/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function doQuestionCodeRunUsingPost(
  ...
  return request<API.BaseResponseLong_>('/api/questionCode/question_submit/run', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
