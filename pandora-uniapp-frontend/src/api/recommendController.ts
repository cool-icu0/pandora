...
export async function getQuestionRecommendListUsingPost(
  ...
  return request<API.BaseResponsePageQuestionRecommendVO_>(
    "/api/recommend/question/list",
    {
      method: "POST",
      headers: {
...
export async function getUserRecommendListUsingPost(
  ...
  return request<API.BaseResponsePageUserRecommendVO_>(
    "/api/recommend/user/list",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
