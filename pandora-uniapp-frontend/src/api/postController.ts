...
/** addPostViews POST /api/post/view/${param0} */
export async function addPostViewsUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.addPostViewsUsingPOSTParams,
  options?: { [key: string]: any }
) {
  const { postId: param0, ...queryParams } = params;
  return request<API.BaseResponseBoolean_>(`/api/post/view/${param0}`, {
    method: "POST",
    params: { ...queryParams },
    ...(options || {}),
  });
...
/** getQuestionViews GET /api/post/view/count/${param0} */
export async function getQuestionViewsUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getQuestionViewsUsingGETParams,
  options?: { [key: string]: any }
) {
  const { postId: param0, ...queryParams } = params;
  return request<API.BaseResponseLong_>(`/api/post/view/count/${param0}`, {
    method: "GET",
    params: { ...queryParams },
    ...(options || {}),
  });
